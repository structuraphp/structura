...
final class AnalyseServiceTest extends TestCase
{
    public function testAnalyseService(): void
    {
        ...
        Should
         ...
         <fire>✘</fire> to not depends on these namespaces <promote>StructuraPhp\Structura\ValueObjects\ClassDescription</promote> <fire>32 error(s)</fire>
         ...
         <fire>✘</fire> to not use trait <fire>9 error(s)</fire>
