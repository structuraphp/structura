...
use StructuraPhp\Structura\Concerns\ExprScript\ThirdPartyAssert as ScriptDeclareAssert;
...
class Expr extends AbstractExpr implements TypeAssertInterface, DependencyAssertInterface, RelationAssertInterface, MethodAssertInterface, ConstantAssertInterface, NameAssertInterface, OtherAssertInterface, ScriptDeclareAssertInterface, ScriptDependencyAssertInterface
{
    use TypeAssert;
